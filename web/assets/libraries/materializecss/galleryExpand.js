    ...
    init : function(options) {
      ...
      return this.each(function(i) {
        ...
        if (!placeholder.length) {
          origin.wrapInner($('<div class="placeholder scrollbar"></div>'));
          placeholder = origin.children('.placeholder').first();
        }
        if (!$header.length) {
        ...
        origin.off('click.galleryExpand').on('click.galleryExpand', function(e) {
          ...
          var backBtn = $('<button class="back-btn"><i class="material-icons">arrow_back</i><span id="gallery-back-button" class="translatable" data-i18n="gallery.button.back">Back</span></button>');
          ...
          i18n.applyOn(document.getElementById("gallery-back-button"));
